...
import com.aicloud.module.member.biz.service.MemberExtensionService;
 ...
 * @author yifei
 */
public class MemberExtensionController {

    private final MemberExtensionService extensionService;

    public MemberExtensionController(MemberExtensionService extensionService) {
