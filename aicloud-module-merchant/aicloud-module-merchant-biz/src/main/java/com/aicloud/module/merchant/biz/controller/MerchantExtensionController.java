...
import com.aicloud.module.merchant.biz.service.MerchantExtensionService;
 ...
 * @author AICloud
 */
public class MerchantExtensionController {

    private final MerchantExtensionService extensionService;

    public MerchantExtensionController(MerchantExtensionService extensionService) {
