...
import com.aicloud.module.merchant.biz.entity.*;
import com.aicloud.module.merchant.biz.mapper.*;
 ...
 */
@Service
public class MerchantExtensionService {
    ...
    public MerchantExtensionService(ObjectMapper objectMapper,
            AiMerchantShopMapper merchantShopMapper,
            AiMerchantFeeRateMapper merchantFeeRateMapper,
            AiMerchantSettlementMapper merchantSettlementMapper,
            AiMerchantWithdrawMapper merchantWithdrawMapper) {
        this.objectMapper = objectMapper;
        register("shop", AiMerchantShop.class, merchantShopMapper, true, "shop_no", "shop_name", "contact_name", "contact_mobile", "address", "status", "remark");
        register("fee-rate", AiMerchantFeeRate.class, merchantFeeRateMapper, true, "channel", "settle_cycle", "status", "remark");
        register("settlement", AiMerchantSettlement.class, merchantSettlementMapper, true, "settlement_no", "status", "remark");
        register("withdraw", AiMerchantWithdraw.class, merchantWithdrawMapper, true, "withdraw_no", "account_no", "account_name", "status", "audit_remark");
    }
