...
import com.aicloud.module.bpm.biz.service.BpmExtensionService;
 ...
 * @author AICloud
 */
public class BpmExtensionController {

    private final BpmExtensionService extensionService;

    public BpmExtensionController(BpmExtensionService extensionService) {
