...
import com.aicloud.module.bpm.biz.entity.*;
import com.aicloud.module.bpm.biz.mapper.*;
 ...
 */
@Service
public class BpmExtensionService {
    ...
    public BpmExtensionService(ObjectMapper objectMapper,
            AiBpmModelMapper bpmModelMapper,
            AiBpmFormMapper bpmFormMapper,
            AiBpmCcMapper bpmCcMapper) {
        this.objectMapper = objectMapper;
        register("model", AiBpmModel.class, bpmModelMapper, true, "model_key", "model_name", "status", "create_by", "remark");
        register("form", AiBpmForm.class, bpmFormMapper, true, "form_key", "form_name", "status", "create_by", "remark");
        register("cc", AiBpmCc.class, bpmCcMapper, false, "username", "remark");
    }
