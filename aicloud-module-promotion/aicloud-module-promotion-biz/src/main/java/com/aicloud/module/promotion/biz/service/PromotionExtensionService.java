...
import com.aicloud.module.promotion.biz.entity.*;
import com.aicloud.module.promotion.biz.mapper.*;
 ...
 */
@Service
public class PromotionExtensionService {
    ...
    public PromotionExtensionService(ObjectMapper objectMapper,
            AiPromotionActivityMapper promotionActivityMapper,
            AiPromotionDiscountRuleMapper promotionDiscountRuleMapper,
            AiPromotionSeckillMapper promotionSeckillMapper) {
        this.objectMapper = objectMapper;
        register("activity", AiPromotionActivity.class, promotionActivityMapper, true, "activity_no", "activity_name", "activity_type", "remark");
        register("discount-rule", AiPromotionDiscountRule.class, promotionDiscountRuleMapper, true, "rule_name", "rule_type");
        register("seckill", AiPromotionSeckill.class, promotionSeckillMapper, true);
    }
