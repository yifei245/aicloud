...
import com.aicloud.module.promotion.biz.service.PromotionExtensionService;
 ...
 * @author AICloud
 */
public class PromotionExtensionController {

    private final PromotionExtensionService extensionService;

    public PromotionExtensionController(PromotionExtensionService extensionService) {
