...
import com.aicloud.module.crm.biz.entity.*;
import com.aicloud.module.crm.biz.mapper.*;
...
public class CrmExtensionService {
    ...
    public CrmExtensionService(ObjectMapper objectMapper,
            AiCrmContactMapper crmContactMapper,
            AiCrmContractMapper crmContractMapper,
            AiCrmReceivableMapper crmReceivableMapper,
            AiCrmCustomerPoolMapper crmCustomerPoolMapper) {
        this.objectMapper = objectMapper;
        register("contact", AiCrmContact.class, crmContactMapper, true, "contact_name", "mobile", "email", "position_name", "remark");
        register("contract", AiCrmContract.class, crmContractMapper, true, "contract_no", "contract_name", "status", "owner_user", "remark");
        register("receivable", AiCrmReceivable.class, crmReceivableMapper, true, "receivable_no", "status", "owner_user", "remark");
        register("customer-pool", AiCrmCustomerPool.class, crmCustomerPoolMapper, true, "pool_reason", "claim_user", "status");
    }
