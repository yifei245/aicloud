...
import com.aicloud.module.crm.biz.service.CrmExtensionService;
...
public class CrmExtensionController {
    ...
    private final CrmExtensionService extensionService;

    public CrmExtensionController(CrmExtensionService extensionService) {
