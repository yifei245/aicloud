...
import com.aicloud.module.erp.biz.entity.*;
...
public class ErpExtensionService {
    ...
    public ErpExtensionService(ObjectMapper objectMapper,
            AiErpWarehouseMapper erpWarehouseMapper,
            AiErpSupplierMapper erpSupplierMapper,
            AiErpPurchaseOrderMapper erpPurchaseOrderMapper,
            AiErpStockTransferMapper erpStockTransferMapper) {
        this.objectMapper = objectMapper;
        register("warehouse", AiErpWarehouse.class, erpWarehouseMapper, true, "warehouse_code", "warehouse_name", "contact_name", "contact_mobile", "address", "remark");
        register("supplier", AiErpSupplier.class, erpSupplierMapper, true, "supplier_code", "supplier_name", "contact_name", "contact_mobile", "contact_email", "address", "remark");
        register("purchase", AiErpPurchaseOrder.class, erpPurchaseOrderMapper, true, "purchase_no", "warehouse_code", "status", "create_by", "audit_by", "remark");
