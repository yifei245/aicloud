...
import com.aicloud.module.product.biz.entity.*;
import com.aicloud.module.product.biz.mapper.*;
...
public class ProductExtensionService {
    ...
    public ProductExtensionService(ObjectMapper objectMapper,
            AiProductBrandMapper productBrandMapper,
            AiProductSkuMapper productSkuMapper,
            AiProductPropertyMapper productPropertyMapper,
            AiProductPropertyValueMapper productPropertyValueMapper) {
        this.objectMapper = objectMapper;
        register("brand", AiProductBrand.class, productBrandMapper, true, "brand_code", "brand_name", "remark");
        register("sku", AiProductSku.class, productSkuMapper, true, "sku_code", "sku_name", "spec_json");
        register("property", AiProductProperty.class, productPropertyMapper, true, "property_code", "property_name", "input_type");
        register("property-value", AiProductPropertyValue.class, productPropertyValueMapper, true, "value_code", "value_name");
    }
