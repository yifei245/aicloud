...
import com.aicloud.module.infra.biz.entity.*;
import com.aicloud.module.infra.biz.mapper.*;
 ...
 */
@Service
public class InfraExtensionService {
    ...
    public InfraExtensionService(ObjectMapper objectMapper,
            AiInfraCodegenTableMapper infraCodegenTableMapper,
            AiInfraCodegenColumnMapper infraCodegenColumnMapper,
            AiInfraStorageConfigMapper infraStorageConfigMapper,
            AiInfraJobLogMapper infraJobLogMapper) {
        this.objectMapper = objectMapper;
        register("codegen-table", AiInfraCodegenTable.class, infraCodegenTableMapper, true, "table_name", "class_name", "module_name", "business_name", "author", "remark");
        register("codegen-column", AiInfraCodegenColumn.class, infraCodegenColumnMapper, false, "column_name", "java_field", "java_type", "query_type");
        register("storage", AiInfraStorageConfig.class, infraStorageConfigMapper, true, "storage_code", "storage_name", "endpoint", "bucket_name", "access_key", "remark");
        register("job-log", AiInfraJobLog.class, infraJobLogMapper, false, "job_name", "handler_name", "error_msg");
    }
