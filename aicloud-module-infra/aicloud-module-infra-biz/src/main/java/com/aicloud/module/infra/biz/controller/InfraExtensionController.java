...
import com.aicloud.module.infra.biz.service.InfraExtensionService;
 ...
 * @author AICloud
 */
public class InfraExtensionController {

    private final InfraExtensionService extensionService;

    public InfraExtensionController(InfraExtensionService extensionService) {
